...
import com.jsplec.mango.dao.MGReviewInsertDao;

public class MGReviewInsertCommand implements MGCommand {
	private static final long serialVersionUID = 1L;
    
	private static final String CHARSET = "utf-8";								// 인코딩
	private static final String ATTACHES_DIR = "/Users/tj/Documents/Web01/Mango_0623/WebContent/img_review/";	// 저장 장소 (하드디스크)
	private static final int LIMIT_SIZE_BYTES = 1024 * 1024 * 10;
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String rating = asd[0];
      int member_id_user= Integer.parseInt(asd[1]);
      String user_name = asd[2];
      String user_img = asd[3];    
      MGReviewInsertDao dao = new MGReviewInsertDao();
      int r_seq = Integer.parseInt(asd[5]);
      String content= asd[6];
      String image= filename;          
      
      dao.insertreview(member_id_user, content, image, rating, user_img, user_name, r_seq);
