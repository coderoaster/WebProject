...
<body>
	...
	<div id="reviewPage">
		...
		<div class="slideshow middle">
			<div class="slides">
				<c:forEach var="review" varStatus="vStatus" items="${review_info}" begin="0" end="0">
					<input type="radio" name="r" id="r${vStatus.index + 1}" checked="checked" value="${review.review_contents}; ${review.member_image}; ${review.member_name}; ${review.date}; ${review.review_evaluation}">
				</c:forEach>
				<c:forEach var="review" varStatus="vStatus" items="${review_info}" begin="1">
					<input type="radio" name="r" id="r${vStatus.index + 1}" value="${review.review_contents}; ${review.member_image}; ${review.member_name}; ${review.date}; ${review.review_evaluation}">
				</c:forEach>
				<c:forEach var="review" varStatus="vStatus" items="${review_info}" begin="0" end="0">
					<div class="slide s1">
						<img src="./img_review/${review.review_image}" alt="">
					</div>
				</c:forEach>
				<c:forEach var="review" varStatus="vStatus" items="${review_info}" begin="1">
					<div class="slide">
		...
		<div class="navigation">
			<c:forEach var="review" varStatus="vStatus" items="${review_info}" begin="0" end="0">
				<label for="r1" class="bar rs"><img src="./img_review/${review.review_image}" alt=""></label>
			</c:forEach>
			<c:forEach var="review" varStatus="vStatus" items="${review_info}" begin="1">
				<label for="r${vStatus.index + 1}" class="bar"><img src="./img_review/${review.review_image}" alt=""></label>
			</c:forEach>
		</div>
		<div id="reviewWord">
			<p style="position: absolute; left: 5%; font-weight: bold;">${restaurant_info.store_name}</p>
